import resume from "./data/Tech_Resume.pdf";
...
export default function Footer(props) {
  ...
  return (
    <section id="footer">
      <div>
        <a href={resume} className="footerLink link" title="Download" tabIndex="0" download>
        ...
        <div className="footerLink link" tabIndex="0" onClick={() => props.contact(true)} onKeyDown={e => e.keyCode === 13 ? props.contact(true) : ''}>
