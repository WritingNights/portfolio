    ...
    render() {
        ...
        return (<div id="pro-book" style={bookMove}>
            ...
            <div id="back-cover">
                ...
                <p>His blog site is&nbsp;
                    <a href="http://www.thenovelistjourney.com" target="_blank" rel="noreferrer" name="novelistjourney">The Novelist Journey</a>
                    &nbsp;(yes, he knows it looks bad).
                </p>
                <p>
                    If you would like to see a story of his growth through&nbsp;
                    <a href="https://freecodecamp.org/writingnights" target="_blank" rel="noreferrer" name="freecodecamp">freeCodeCamp.org</a>
                    &nbsp;then take a look at his&nbsp;
                    <a href="https://codepen.io/writingnights" target="_blank" rel="noreferrer" name="codepen">CodePen Profile</a>
                    &nbsp;to see projects.
                </p>
