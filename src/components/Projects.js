...
function Book(props) {
    ...
    return (<div id="pro-book">
        ...
        <div id="back-cover">
            ...
            <p>His blog site is&nbsp;
                <a href="http://www.thenovelistjourney.com" target="_blank" rel="noreferrer">The Novelist Journey</a>
                &nbsp;(yes, he knows it looks bad).
            </p>
            <p>
                If you would like to see a story of his growth through&nbsp;
                <a href="https://freecodecamp.org/writingnights" target="_blank" rel="noreferrer">freeCodeCamp.org</a>
                &nbsp;then take a look at his&nbsp;
                <a href="https://codepen.io/writingnights" target="_blank" rel="noreferrer">CodePen Profile</a>
                &nbsp;to see projects.
            </p>
        </div>
    </div>);
