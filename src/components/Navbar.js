...
class Navbar extends React.Component {
    ...
    anchorShift() {
        ...
        gsap.fromTo('#nav-left', {transform: 'translate(0)', opacity: 1}, {transform: 'translateX(-110%)', opacity: 0, duration: 1, ease: 'power3.out', onComplete: () => this.setState({ expanded: !expanded })});
    ...
    render() {
        return (
            <div id="navbar">
                {this.state.expanded ? (<div id="nav-left" style={{maxWidth: `calc(100% - ${this.ref.current.offsetWidth}px)`}} className={`${this.props.mode}navbar-left`}>
                    <div id="closeAnchors" onClick={this.anchorShift}>
                    ...
                    <a href="#about" className="leftLink" title="About" value="about" onMouseOver={this.hoverEffect} onMouseOut={this.hoverStop}>
                    ...
                    <a href="#projects" className="leftLink" title="Projects" value="projects" onMouseOver={this.hoverEffect} onMouseOut={this.hoverStop}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill={this.props.light ? 'black' : 'white'} className="bi bi-code-slash" id="projectsSVG" viewBox="0 0 16 14">
                    ...
                    <a href="#contact" className="leftLink" title="Contact" value="contact" onMouseOver={this.hoverEffect} onMouseOut={this.hoverStop}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill={this.props.light ? 'black' : 'white'} className="bi bi-envelope" id="contactSVG" viewBox="0 0 16 14">
                            <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2zm13 2.383-4.758 2.855L15 11.114v-5.73zm-.034 6.878L9.271 8.82 8 9.583 6.728 8.82l-5.694 3.44A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.739zM1 11.114l4.758-2.876L1 5.383v5.73z"/>
                        </svg>
                        &nbsp;Contact
                    </a>
                    <div className={`${this.props.mode}mode-container mode-container`}>
                        <div onClick={this.props.updateTheme} className={`${this.props.mode}toggle toggle`} title="Dark Mode">
                            {this.props.light ? (
                ...
                </div>) : (<div id="nav-left" className={`${this.props.mode}navbar-left`}>
                    <div id="openAnchors" onClick={this.anchorShift}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill={this.props.light ? 'black' : 'white'} className="bi bi-chevron-right" viewBox="0 0 16 16">
                ...
                <div id="nav-right" ref={this.ref}>
                    <div id="socialIcon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#444" className="bi bi-globe" viewBox="0 0 16 16">
                    ...
                    <div id="socials">
                        <a href="https://twitter.com/the_left_half" id="twitter" title="Twitter">
                        ...
                        <a href="https://www.linkedin.com/in/daniel-jones-91a279168/" id="linkedin" title="LinkedIn">
                        ...
                        <a href="https://github.com/WritingNights/WritingNights/tree/main" id="github" title="Github">
